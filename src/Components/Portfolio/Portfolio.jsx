...
const Portfolio = () => {
  return (
    ...
    <TarjetaPortfolio urlImagen={"https://res.cloudinary.com/dcf9eqqgt/image/upload/v1710075474/portafolio/Captura_de_pantalla_2024-03-10_a_las_13.24.47_g5utrx.jpg"} demo={"https://tiendadigital.vercel.app/"} nombre={"Gaming Store"} infoProyecto={"Tienda de productos gaming, los usuarios van a poder registarse, seleccionar los productos que quieran obtener y finalizar su compra."}  />
    ...
    <TarjetaMobilev2 nombre={"Compra Gamer"} urlImagen={"https://res.cloudinary.com/dcf9eqqgt/image/upload/v1710075474/portafolio/Captura_de_pantalla_2024-03-10_a_las_13.24.47_g5utrx.jpg"} demo={"https://tiendadigital.vercel.app/"} description={"e-comerce de una tienda de productos para gaming, en el que cualquier comprador puede agregar sus productos a un carrito y enviarle el pedido al local para gestionar su envio a domicilio"}/>
