...
const Portfolio = () => {
  return (
    ...
    <TarjetaMobilev2 nombre={"TMovies"} urlImagen={"https://res.cloudinary.com/dcf9eqqgt/image/upload/v1699665336/portafolio/para_el_portafolio_api_peliculas_ck2w3y.png"}  demo={"https://app-del-clima-two.vercel.app/"} description={"App que consume la API TMDB para búsquedas, detalles de películas, reparto, y series con temporadas y episodios."}/>
    <TarjetaMobilev2 nombre={"TuHistoria.com"} urlImagen={"https://res.cloudinary.com/dcf9eqqgt/image/upload/v1699665336/portafolio/para_el_portafolio_api_peliculas_ck2w3y.png"}  demo={"https://app-del-clima-two.vercel.app/"} description={"App para compartir con la comunidad historia raras que te hayan pasado, pudiendo intercambiar ideas y agregar imagenes a nustras historias favoritos."}/>
