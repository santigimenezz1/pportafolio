...
const Portfolio = () => {
  return (
    ...
    <TarjetaPortfolio urlImagen={"https://res.cloudinary.com/dcf9eqqgt/image/upload/v1699665336/portafolio/para_el_portafolio_api_peliculas_ck2w3y.png"}  demo={"https://app-del-clima-two.vercel.app/"} nombre={"WeatherWise"} infoProyecto={"Proyecto que consume la api de Open Weather map, donde podemos buscar cualquier cuidad del mundo, agregarlas a una seccion de favoritos y obtener los datos climaticos del día y sus 5 dias posteriores."}/>
    ...
    <TarjetaMobilev2 nombre={"El Clima"} urlImagen={"https://res.cloudinary.com/dcf9eqqgt/image/upload/v1699665336/portafolio/para_el_portafolio_api_peliculas_ck2w3y.png"}  demo={"https://app-del-clima-two.vercel.app/"} description={"App que nos devuelve el pronostico del tiempo actual y el de los próximos dias de cualquier cuidad del mundo"}/>
