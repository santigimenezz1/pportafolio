...
const Portfolio = () => {
  return (
    ...
    <TarjetaPortfolio urlImagen={"https://res.cloudinary.com/dcf9eqqgt/image/upload/v1698006749/portafolio/clima_2_yggudl.png"}  demo={"https://app-del-clima-two.vercel.app/"}/>
