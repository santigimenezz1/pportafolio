...
const Portfolio = () => {
  return (
    ...
    <TarjetaPortfolio urlImagen={"https://res.cloudinary.com/dcf9eqqgt/image/upload/v1717198986/portafolio/Imagen_1-6-24_a_las_1.41_wglbum.jpg"}  demo={"https://aura-rust.vercel.app"} nombre={"Stock de fotos"} infoProyecto={"Descubre una aplicación donde puedes realizar búsquedas de imágenes y videos, con acceso a una amplia variedad de recursos. Explora y descarga tus imágenes favoritas con facilidad"}/>
    ...
    <TarjetaPortfolio urlImagen={"https://res.cloudinary.com/dcf9eqqgt/image/upload/v1717976956/portafolio/Imagen_10-6-24_a_las_1.03_k5hiqc.jpg"}  demo={"https://fortafit-blush.vercel.app"} nombre={"FortaFit"} infoProyecto={"Descubre una aplicación donde puedes realizar búsquedas de imágenes y videos, con acceso a una amplia variedad de recursos. Explora y descarga tus imágenes favoritas con facilidad"}/>
    <TarjetaPortfolio urlImagen={"https://res.cloudinary.com/dcf9eqqgt/image/upload/v1717976956/portafolio/Captura_de_pantalla_2024-06-10_a_las_1.37.19_yjaatn.jpg"}  demo={"https://photosnap-kohl.vercel.app"} nombre={"Photo Snap"} infoProyecto={"Descubre una aplicación donde puedes realizar búsquedas de imágenes y videos, con acceso a una amplia variedad de recursos. Explora y descarga tus imágenes favoritas con facilidad"}/>
    <TarjetaPortfolio urlImagen={"https://res.cloudinary.com/dcf9eqqgt/image/upload/v1718008258/portafolio/Imagen_10-6-24_a_las_10.30_hcoayb.jpg"}  demo={"https://cafe-aroma.vercel.app"} nombre={"Café Aroma"} infoProyecto={"Descubre una aplicación donde puedes realizar búsquedas de imágenes y videos, con acceso a una amplia variedad de recursos. Explora y descarga tus imágenes favoritas con facilidad"}/>
